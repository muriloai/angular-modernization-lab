...
@Component({
  ...
  template: `
    <div class="widget-box widget-rain">
      <div class="widget-badge">Pluviometria Digital (Signal Inputs)</div>
...
export class PluviometroWidget {
  readonly localizacao = input('Talhão 04 - Pivô Central');
  readonly valorPrincipal = input('42.5 mm');
}
