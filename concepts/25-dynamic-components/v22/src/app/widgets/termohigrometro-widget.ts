...
@Component({
  ...
  template: `
    <div class="widget-box widget-temp">
      <div class="widget-badge">Microclima e Dossel (Signal Inputs)</div>
...
export class TermohigrometroWidget {
  readonly localizacao = input('Talhão 08 - Baixada Úmida');
  readonly valorPrincipal = input('28.4°C / 64%');
}
