...
@Component({
  ...
  template: `
    <div class="widget-box widget-wind">
      <div class="widget-badge">Segurança Operacional (Signal Inputs)</div>
...
export class AnemometroWidget {
  readonly localizacao = input('Pista de Operação de Drones');
  readonly valorPrincipal = input('12.6 km/h (Sudeste)');
}
